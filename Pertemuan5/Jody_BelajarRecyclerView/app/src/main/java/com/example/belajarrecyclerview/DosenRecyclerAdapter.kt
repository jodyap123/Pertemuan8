...
class DosenRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private  var items: List<LisObjDosen> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return DosenViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.layout_list_dosen, parent, false)
        )
    }
    ...
    fun submitList(listDosen: List<LisObjDosen>){
        items = listDosen
    }
    ...
    class DosenViewHolder constructor(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(listObjDosen: LisObjDosen) {
        ...
        fun kalau_diklik(get: LisObjDosen){
